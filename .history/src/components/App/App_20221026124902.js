      ...
      <div>
        ...
        <div className="App">
          ...
          <div className="App-playlist">
            ...
            <Playlist setPlaylistName={this.updatePlaylistName} onRemove={this.removeTrack} onAdd={this.addTrack} playlistName={this.state.playlistName} playlistTracks={this.state.playlistTracks}/>
          </div>
        </div>
      </div>
    );
